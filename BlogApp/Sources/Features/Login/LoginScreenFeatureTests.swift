...
final class FakeSessionService: SessionServiceProtocol {
    var observableSessionState: ReadonlyObservable<SessionState> {
    ...
    var stubbedSessionState = MutableObservable<SessionState>(.readyToStart)
